  ...
  ;(function () {
    ...
    adpPopup = {
      ...
      handleButtonClick: function (e) {
        ...
        if (
          target.classList.contains('popup-accept') ||
          target.closest('.popup-accept')
        ) {
      ...
      closePopupsByAttribute: function (attribute) {
        var closeItems = document.querySelectorAll(
          `.popup-open[${attribute}="true"]`
        )
      ...
      closeTriggerPopup: function (e) {
        ...
        if ('scroll' === trigger) {
          ...
          var pointScrollPosition = parseFloat(
            popup.dataset.closeScrollPosition
          )
          ...
          document.addEventListener('scroll', () => {
            ...
            if (
              scrollConditionUp ||
              scrollConditionDown ||
              scrollConditionPercentUp ||
              scrollConditionPercentDown
            ) {
              $this.closePopup(popup)
            }
          })
      ...
      openPopup: function (popup) {
        if (
          null !== popup.getAttribute('data-body-scroll-disable') &&
